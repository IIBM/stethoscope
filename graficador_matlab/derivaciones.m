...
archivo_canal_1="Datos/Fabricio-Alcalde/Fabricio-Alcalde_2018-03-20_17-32-31_c1_11.txt";
archivo_canal_2="Datos/Fabricio-Alcalde/Fabricio-Alcalde_2018-03-20_17-32-31_c2_11.txt";
...
derivacion=[cos(30); sin(30)].*ones(size(registro));

DII=dot(registro, derivacion, 1);

L1=max(abs(DII(X1:X2)));
L1=L1*1.1;

plot(DII,'linewidth',1)
ylim([-L1 L1])
xlim([X1 X2])
