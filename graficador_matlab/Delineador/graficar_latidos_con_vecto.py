...
for pos in range(6,7):
    ...
    paciente=[paciente for paciente in lista_pacientes if "Fabricio" in paciente.nombre]
    ...
    #fig.canvas.draw() 
    #canal1_xlabels = [item.get_text() for item in canal1.get_xticklabels()]
    #print(canal1_xlabels)
    #canal2_ylabels = [item.get_text() for item in canal2.get_yticklabels()]
    #print(canal2_ylabels)
    plt.ion()
    plt.show()
