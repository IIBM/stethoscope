...
%[DATAExpanded] = ExpandData (RegistrosECG, 1);

%a=DATAExpanded*RegistrosECG.Pendiente;
...
%v(n) = Ts(n)
%donde s(n)=[V1(n) V2(n) V3(n) V4(n) V5(n) V6(n) I(n) II(n)] and v(n)=[X(n) Y (n) Z(n)]^T
...
% x- y- z- x+ y+ z+
posiciones=[16,-100,-124,8,-103,-128;
            80,-57,-128,99,-61,-113;
            150,-30,-73,153,-27,-42;
            144,-23,7,137,-21,21;
            106,-22,54,74,-24,65;
